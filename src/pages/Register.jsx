  ...
  return (
    <>
      ...
      <section className="mx-auto p-3 sm:max-w-7xl sm:p-8">
        {/* Header */}
        <motion.div
          className="mx-auto space-y-2 py-12 text-center sm:py-16"
          initial={{ y: 50, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.8, delay: 0.2, ease: "easeOut" }}
        >
          <motion.h2
            className="text-[1.5rem] font-bold sm:pt-3 sm:text-[1.8rem] md:pt-5 lg:text-[2rem] xl:pt-8 xl:text-[2.4rem]"
          ...
          <motion.p
            className="text-primaryTextColor/90 text-[1.1rem] sm:text-[1.2rem] lg:pt-1 lg:text-[1.4rem] xl:text-[1.6rem]"
